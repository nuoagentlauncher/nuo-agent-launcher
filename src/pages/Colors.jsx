      ...
      <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{
          ...
          <p style={{ color: 'var(--text-tertiary)', fontSize: 13, margin: 0, marginBottom: 20 }}>
            请先在「下载」页面点击底部 <Icon name="zap" size={13} /> 图标开启开发者模式
          </p>
          <button
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{
            ...
            >
              ...
              <span style={{ fontSize: 12, color: 'var(--text-tertiary)', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                <Icon name={showAdvanced ? 'chevron-up' : 'chevron-down'} size={13} /> {showAdvanced ? '收起' : '展开'}
              </span>
            </button>
            {showAdvanced && (
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            ><Icon name="save" size={16} /> 保存配色</button>
            <button
              onClick={resetColors}
              style={{
            ...
            ><Icon name="reset" size={15} /> 恢复默认</button>
            {saved && <span style={{ fontSize: 13, color: 'var(--success)', display: 'inline-flex', alignItems: 'center', gap: 5 }}><Icon name="check" size={14} /> 已保存，重启应用后依然生效</span>}
          </div>
        </div>
      </div>
    </div>
