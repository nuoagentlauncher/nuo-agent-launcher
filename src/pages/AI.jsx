...
const QUICK_PROMPTS = [
  ...
  '如何在 Minecraft 中合成蛋糕？',
  '如何在 PCL/nuo agent launcher 中下载 Forge？',
...
const SYSTEM_PROMPT = {
  role: 'system',
  content: '你是 nuo agent launcher 内置的 AI 助手。请用简洁清晰的中文回答问题，针对 Minecraft 玩家和启动器用户的需求提供帮助。可以使用 Markdown 格式排版。不要输出思考过程，直接给出回答。',
}
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          {messages.length === 0 && !streamingText ? (
            <div style={{ textAlign: 'center', padding: '60px 0' }}>
              ...
              <h2 className="text-xl" style={{ fontWeight: 600, marginBottom: 8 }}>你好！我是 nuo agent launcher 的 AI 助手</h2>
