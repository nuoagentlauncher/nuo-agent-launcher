        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="btn btn-ghost btn-sm" onClick={refresh} disabled={loading}>
              {loading ? <><span className="spinner" />刷新中</> : <><Icon name="refresh" size={14} /> 刷新</>}
            </button>
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button className="btn btn-ghost btn-sm" onClick={() => refresh(true)} disabled={loading}>
              {loading ? <><span className="spinner" />获取中</> : <><Icon name="refresh" size={14} /> 实时刷新</>}
            </button>
            <button className="btn btn-ghost btn-sm" onClick={openDir}>打开目录</button>
            <button className="btn btn-primary btn-sm" onClick={handleLaunch}><Icon name="play" size={13} /> 启动基岩版</button>
          </div>
        </div>
      </div>
