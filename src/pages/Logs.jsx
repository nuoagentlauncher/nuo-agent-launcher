...
const CATEGORIES = [
  { id: 'launcher', name: '启动日志', icon: 'rocket' },
  { id: 'download', name: '下载日志', icon: 'download' },
  { id: 'java', name: 'Java 日志', icon: 'coffee' },
  { id: 'multiplayer', name: '联机日志', icon: 'users' },
  { id: 'ai', name: 'AI 日志', icon: 'sparkles' },
  { id: 'account', name: '账号日志', icon: 'user' },
  { id: 'system', name: '系统日志', icon: 'settings' },
]
    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '16px 24px', borderBottom: '1px solid var(--border-color)' }}>
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl" style={{ fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8 }}><Icon name="clipboard" size={20} /> 日志 / 记录</h1>
          <div className="flex gap-2">
            <button className="btn btn-ghost btn-sm" onClick={() => refresh()}><Icon name="refresh" size={14} /> 刷新</button>
